...
public class RPG extends BasicGame
{
    ...
    /** Maximum X pixel of the map. */
    public static final double MAX_X_PIXEL = 96*72;
    /** Maximum Y pixel of the map. */
    public static final double MAX_Y_PIXEL = 96*72;
    /** Minimum X pixel of the map. */
    public static final double MIN_X_PIXEL = 0;
    /** Minimum Y pixel of the map. */
    public static final double MIN_Y_PIXEL = 0;
